...
\begin{frame}
	...
	\only<5>{
		\framesubtitle{(v)}
		\begin{itemize}
			\item[$\Diamondblack$]{\large{\color{violet}Πληροφορική}: μαθηματικοποίηση
				της μεθοδολογίας των μηχανικών}
			\begin{itemize}
				\item Απαιτήσεις - Πρόβλημα
				\item Προδιαγραφές
				\item Σχεδίαση
				\item Υλοποίηση
				\item Εμπειρικός έλεγχος - Θεωρητική επαλήθευση
				\item Βελτιστοποίηση
				\item Πολυπλοκότητα (κόστος πόρων-αγαθών)
				\item Τεκμηρίωση
				\item Συντήρηση
			\end{itemize}
			Έννοιες που υπήρχαν για τους μηχανικούς, στην πληροφορική τυποποιήθηκαν,
			πήραν μαθηματική μορφή, άρα μπορεί κανείς να επιχειρηματολογήσει με αυτές
			τις έννοιες χρησιμοποιώντας αποδείξεις.
		\end{itemize}
	}
	...
	\only<6>{
		\framesubtitle{(vi)}
		\begin{itemize}
			\item[$\Diamondblack$]{\large Δευτεροβάθμια εκπαίδευση\\
					{\color{violet}Σκοπός}: να μάθεις να σκέφτεσαι}
			\begin{itemize}
				\item Η Ευκλείδεια Γεωμετρία (με βάση τη διδακτική της αξία)
					απουσιάζει από το πρόγραμμα σπουδών εδώ και χρόνια.
				\item Αποτέλεσμα: όπως είδαμε και στις πανελλήνιες εξετάσεις, δίνεται
					έμφαση στην αποστήθιση ανουσίων θεωρημάτων και γνώσεων διαφορικού
					και απειροστικού λογισμού. Η ικανότητα μαθηματικής επίλυσης απλών
					αλλά και πρωτότυπων προβλημάτων δεν παίζει ρόλο.
				\item Απουσία γνώσεων συνδυαστικής (μέτρηση περιπτώσεων, τρίγωνο
					Pascal)
				\item Εφαρμογή των αποστηθισμένων κανόνων;
				\item Άλγεβρα: αν ρωτήσω έναν τελειόφοιτο Λυκείου πόσο κάνει $107
					\times 93$ θα δυσκολευτεί πολύ να απαντήσει, ενώ φυσικά γνωρίζει ότι
					(α+β)(α-β) = α$^2$-β$^2$
			\end{itemize}
		\end{itemize}
	}
